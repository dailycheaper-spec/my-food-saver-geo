...
CREATE OR REPLACE FUNCTION public.generate_pending_payouts(_commission numeric DEFAULT 0.10, _min_payout numeric DEFAULT 0.5, _generated_by text DEFAULT 'cron'::text)
