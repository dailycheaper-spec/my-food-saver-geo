...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // Sitewide fallbacks only — every content route sets its own title/description.
      { title: "Cheaper — ფასდაკლებული საკვები საქართველოში" },
      { name: "description", content: "Cheaper აკავშირებს მომხმარებელს საცხობებთან, რესტორნებთან და მარკეტებთან, სადაც დღის ბოლოს დარჩენილი საკვები 50%+ ფასდაკლებით იყიდება." },
      { property: "og:site_name", content: "Cheaper" },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "ka_GE" },
      { name: "twitter:card", content: "summary_large_image" },
      { property: "og:image", content: "https://cheaper.ge/og-image-v2.png" },
      { name: "twitter:image", content: "https://cheaper.ge/og-image-v2.png" },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Cheaper",
          alternateName: "Cheaper.ge",
          url: "https://cheaper.ge",
          logo: "https://cheaper.ge/icon-512-v2.png",
          image: "https://cheaper.ge/og-image-v2.png",
          areaServed: "GE",
          sameAs: ["https://cheaper.ge"],
        }),
      },
      {
        type: "application/ld+json",
        children: JSON.stringify({
          ...
          potentialAction: {
            "@type": "SearchAction",
            target: "https://cheaper.ge/search?q={search_term_string}",
