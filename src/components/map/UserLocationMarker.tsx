    ...
    () =>
      L.divIcon({
        html: `<div class="user-loc-dot" style="position:relative;transform:translate(-50%,-50%)">
          <span style="position:absolute;inset:-14px;border-radius:9999px;background:hsl(var(--primary)/.25);animation:userloc-pulse 1.8s ease-out infinite"></span>
        ...
        <style>@keyframes userloc-pulse{0%{transform:scale(.6);opacity:.9}100%{transform:scale(1.6);opacity:0}}</style>`,
        className: "",
        iconSize: [0, 0],
      }),
    [],
